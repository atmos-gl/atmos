...
import {combineLoaders, exploreLoader, commonLoader, powerBlockLoader, growLoader} from '../composables/useLoader';
import {delay} from '../utils';

const {loading, progress, load} = combineLoaders(commonLoader, exploreLoader, powerBlockLoader, growLoader)

...
<template>
  <transition name="fade">
    <div v-show="visible" class="absolute right-0 top-1/2 transform -translate-y-1/2 translate-x-3 h-full bg-bg flex items-center pl-64 gradient">
      <div class="border border-px border-white bg-imperial text-jade px-16 py-12 w-md rounded-xl z-5">

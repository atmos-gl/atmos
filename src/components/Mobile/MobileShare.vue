...
const shareResult = () => {
  const filesArray: File[] = [new File([image.value], 'tomates.png', {
...
<template>
  <Transition name="fade">
    <div v-show="ready" class="flex flex-col h-full p-10 items-center gap-3 text-jade">
      <h1 class="text-6xl font-title font-bold">Bravo !</h1>
      <img :src="imageSrc" class="w-full my-4" @load="ready = true">

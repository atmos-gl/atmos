const data = [
    ...
    },
    {
        ...
        content: [
            {
                text: "Vous avez une grande pièce ? Augmentez votre productivité en connectant une seconde serre à la même centrale, et partagez les ressources entre les deux."
            }
        ],
        features: [
            {
